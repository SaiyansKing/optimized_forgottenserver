...
enum CombatParam_t {
	...
	COMBAT_PARAM_VALIDTARGETS
};

enum TargetsParam_t {
	COMBAT_TARGET_PARAM_PLAYERS = 1,
	COMBAT_TARGET_PARAM_MONSTERS = 2,
	COMBAT_TARGET_PARAM_PLAYERSANDMONSTERS = 3,
	COMBAT_TARGET_PARAM_NPCS = 4,
	COMBAT_TARGET_PARAM_PLAYERSANDNPCS = 5,
	COMBAT_TARGET_PARAM_MONSTERSANDNPCS = 6,
	COMBAT_TARGET_PARAM_ALL = 7,
};
